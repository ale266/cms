...
urlpatterns = [
    ...
    path('create-images', views.createImages, name= 'create_images'),
    path('update-images/<int:id>', views.updateImages, name= 'update_images'),
    path('delete-images/<int:id>', views.deleteImages, name= 'delete_images'),
